...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-nova-text-limit', __webpack_require__(3));
  Vue.component('detail-nova-text-limit', __webpack_require__(6));
  Vue.component('form-nova-text-limit', __webpack_require__(9));
});
  ...
  return _c(
    ...
    [
      _c("template", { slot: "value" }, [
        _vm.field.value && _vm.field.isLink
          ? _c(
              "a",
              {
                staticClass:
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        isOverMaxLength: function isOverMaxLength() {
    ...
    [
      _c("template", { slot: "field" }, [
        ...
        _vm.field.maxLength
          ? _c(
              "span",
              { staticClass: "text-sm ml-2", class: _vm.isOverMaxLength },
              [
                _vm._v(
                  "\n            " +
                    _vm._s(_vm.value.length) +
                    " / " +
                    _vm._s(_vm.field.maxLength) +
                    "\n        "
                )
              ]
            )
